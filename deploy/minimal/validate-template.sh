...
rg -q 'DashboardPortForwardCommand' "$template"
rg -q 'AWS-StartPortForwardingSession' "$template"
...
rg -q 'P-006-preserve-workspace-for-nested-mounts.patch' "$runtime_config"
